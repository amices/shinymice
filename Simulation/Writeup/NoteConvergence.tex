...
For reasons of brevity, this note only focuses on the MI algorithm implemented in \pkg{mice} \citep{mice}. %The implementation limits itself to the MI algorithm 
