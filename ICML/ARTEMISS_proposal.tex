...
For example, in Figure \ref{fig:res} we see that... The novel parameter has equal performance to the quantity of scientific interest as parameter ($r=.975$), while having the advantage of being model-independent.
