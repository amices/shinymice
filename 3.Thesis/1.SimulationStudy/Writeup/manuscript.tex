...
not (yet) converged, and vice versa?}
...
\citep{veht19}. Therefore, use we \(AC\) and \(\widehat{R}\) to evaluate
stationarity and mixing separately, as recommended by e.g.,
\citet{cowl96}, p.~898.
...
\hypertarget{simulation-hypothesis-als-bullets}{%
\subsection{Simulation Hypothesis (als
bullets!!)}\label{simulation-hypothesis-als-bullets}}
