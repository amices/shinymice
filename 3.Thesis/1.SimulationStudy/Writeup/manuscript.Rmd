---
title: "Missing the Point: Convergence of Multiple Imputation by Chained Equations Algorithms"
...
```{r, echo=FALSE, fig.cap="Convergence diagnostics (means)"}
bias_means_plot + R_means_plot + AC_means_plot + plot_layout(nrow = 3, guides = "collect")
```

```{r, echo=FALSE, fig.cap="Convergence diagnostics (variances)"}
bias_sds_plot + R_sds_plot + AC_sds_plot + plot_layout(nrow = 3, guides = "collect")
```

```{r, echo=FALSE, fig.cap="Convergence diagnostics (regression coefficients)"}
