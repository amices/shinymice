...
author: "Hanne Oberman, December 16, 2019"
date: "Supervisors: Stef van Buuren and Gerko Vink | Mentor: Daniela Cianci"
output: 
...
# if necessary, load the results from 'ResearchReport/SimulationStudy/1.Excecute.R'
load("C:/Users/User/Desktop/shinyMice/2.ResearchReport/1.SimulationStudy/Results/results.Rdata")
```
...
## Multiple imputation <footnote content="Figure adapted from van Buuren (2018)"></footnote>
...
## Algorithmic convergence <footnote content="Figure adapted from van Buuren (2018)"></footnote>
<center>
...
## Results: simulation diagnostics <footnote content="Results obtained using R (2019)"></footnote>
<center>
...
## Results: convergence diagnostics <footnote content="Results obtained using R (2019)"></footnote>
<center>
...
## Results <footnote content="Results obtained using R (2019)"></footnote>
<center>
...
## Discussion <footnote content="Figure adapted from mice (2014) and Shiny (2017)"></footnote>
<center>
...
## Impression of ShinyMICE <footnote content="Figure adapted from mice (2014) and Shiny (2017)"></footnote>
<center>
<br>
...
## Equations $\widehat{R}$ <footnote content="Adapted from Vehtari et al. (2019)"></footnote>
\[\begin{align}
