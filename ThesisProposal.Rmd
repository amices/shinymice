...
The numerous assumptions inherent to MI methods, can be roughly divided into assumptions about: 1) the *missingness mechanism*; 2)  the relation between observed and missing parts of the data (*imputation model*); and 3) the *non-response model*. By definition, assumptions cannot be verified on missing data. Therefore, proxy measures are used. 
