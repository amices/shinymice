...
*That is, the overdispersed initial state of the MICE algorithm does not conform to $\widehat{R}$'s assumption of equal starting points (source!).*

Notwithstandingly, it seems like @su11 did implement $\widehat{R}$ as convergence criterion into their R package 'mi', including the conventional cut-off of 1.1.
